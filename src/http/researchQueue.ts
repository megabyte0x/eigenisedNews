...
export function mountResearchQueueApi(app: Express, deps: RunSynthesisDeps): void {
  const queue = new ArticleResearchQueue(deps, readResearchQueueOptions(process.env));
